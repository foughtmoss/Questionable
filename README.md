...
2. You can edit the contexts list or the model prompt in the question.py file to change language or style of the question as you like (currently the style is punk but you can make it family friendly).
